...
public class Alumno {
	...
	@Size(min=9,max=10,message="El Rut no debe ser mayor ni menor de 9 ")
	@Column(name="Rut", length = 10)
	private String Rut;
	

	
	@Size(min=5,max=20,message="El Primer Nombre debe ser mayor o igual de 5 ")
	@Column(name="Nombre1", length = 30)
	private String Nombre1;
	
	
	
	@Size(min=5,max=20,message="El Segundo Nombre debe ser mayor o igual de 5")
	@Column(name="Nombre2", length = 30)
	private String Nombre2;
	
	
	
	@Size(min=5,max=20,message="El Primer Apellido debe ser mayor o igual de 5 ")
	@Column(name="Apellido1", length = 30)
	private String Apellido1;
	

	
	@Size(min=5,max=20,message="El Segundo Apellido debe ser mayor o igual de 5 ")
	@Column(name="Apellido2", length = 30)
	private String Apellido2;


	@ManyToOne
    @JoinColumn(name = "id_asistencia", nullable = false, foreignKey = @ForeignKey(name = "FK_alumno_asistencia"))
