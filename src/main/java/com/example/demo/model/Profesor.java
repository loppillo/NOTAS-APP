...
public class Profesor {
    ...
    @Size(min=8,max=30,message="El Nombre Del Profesor debe ser igual o mayor de 8 y menor o igual a 30")	
	@Column(name="NombreProfesor" , length = 30)
	private String NombreProfesor;
	
    @Size(min=8,max=30,message="El Apellido Del Profesor debe ser igual o mayor de 8 y menor o igual a 30")	
